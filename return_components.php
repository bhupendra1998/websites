                        ...
                        <div class="x_panel">
							...
							<table class="table table-bordered">
                                <tr>
									...
									<?php
									$res = mysqli_query($link,"select student_enrollment from issue_components where c_return_date = ''");
							...
							{
							$res = mysqli_query($link, "select * from  issue_components where student_enrollment='$_POST[enr]'");
							...
							echo "<th>"; echo "component issue date";     echo "</th>";
							echo "<th>"; echo "return component";     echo "</th>";
							echo "</tr>";
							while($row = mysqli_fetch_array($res))
							{
							    echo "<tr>";
								...
								echo "<td>"; ?> <a href="return.php?id=<?php echo $row["id"]; ?>"> Return Component</a> <?php echo "</td>";
