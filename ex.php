...
{
    mysqli_query($link,"insert into add_comp values ('','$_POST[cname]','$_POST[c_purchase_date]','$_POST[c_price]','$_POST[c_qyt]','$_POST[a_qyt]')")

?>
<script type="text/javascript">
    alert("component insert successfully");
</script>
<?php
}
